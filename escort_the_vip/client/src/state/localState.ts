...
export interface LocalState {
  ...
  // Wall under cursor for bomb-targeting — set on PET_HOVER_ENTER for
  // hedges / fences / doors, cleared on HOVER_LEAVE. Read by combatInput
  // when E is pressed with a bomb to decide where the bomb goes (own tile
  // with countdown vs. door-trap on hovered door).
  bombTargetWallIdx:     number
