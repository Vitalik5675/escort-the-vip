...
export interface LocalState {
  ...
  // Bomb fuse duration in milliseconds — synced from server scene_config
  // (cfg.BOMB_FUSE_MS). Used in "How to Play" text so the description always
  // matches the actual configured value instead of a hardcoded "5 s".
  bombFuseMs: number
