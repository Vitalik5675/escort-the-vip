...
const GAME_CENTER = Vector3.create(16, GAME_ZONE_Y + WALL_HEIGHT / 2, 16)   // 32×3×32 m
const GAME_SIZE   = Vector3.create(32, WALL_HEIGHT, 32)

const SPEC_CENTER = Vector3.create(16, 2, 28)                                // 16×4×4 m (moved north)
