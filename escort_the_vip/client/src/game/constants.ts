...
export const GAME_ZONE_CENTER = { x: 16, y: 16.5, z: 16 }
...
export const WALL_METAL_WALL = 3
export const WALL_WOOD_FENCE = 4
export const WALL_METAL_DOOR = 5
export const WALL_WOOD_DOOR  = 6
